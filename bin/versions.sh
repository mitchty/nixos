...
for pkg in keepingyouawake franz clocker maccy gh-action-status hidden nheko obs-studio stats stretchly swiftbar wireshark vlc hwatch jira-cli transcrypt xq; do
