...
for pkg in freetube keepingyouawake ferdium clocker maccy gh-action-status hidden nheko obs-studio stats stretchly swiftbar wireshark vlc hwatch jira-cli transcrypt xq helm-unittest; do
